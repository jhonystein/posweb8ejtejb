...
public class Movimentacao  implements java.io.Serializable {
    private controle.Cliente cliente;
    ...
    private controle.Loja loja;

    private int ponto;

    private controle.Produto produto;

    private controle.TipoMovimentacao tipo;
    ...
    public Movimentacao(
           ...
           controle.Loja loja,
           int ponto,
           controle.Produto produto,
           controle.TipoMovimentacao tipo) {
     ...
     * @return cliente
     */
    public controle.Cliente getCliente() {
        return cliente;
    }
     ...
     * @param cliente
     */
    public void setCliente(controle.Cliente cliente) {
        this.cliente = cliente;
    }
     ...
     * @param loja
     */
    public void setLoja(controle.Loja loja) {
        this.loja = loja;
    }
     ...
     * @return produto
     */
    public controle.Produto getProduto() {
        return produto;
    }
     ...
     * @param produto
     */
    public void setProduto(controle.Produto produto) {
        this.produto = produto;
    }
     ...
     * @return tipo
     */
    public controle.TipoMovimentacao getTipo() {
        return tipo;
    }
     ...
     * @param tipo
     */
    public void setTipo(controle.TipoMovimentacao tipo) {
        this.tipo = tipo;
    }
