...
public class ExtratoPontosUCServiceLocator extends org.apache.axis.client.Service implements controle.ExtratoPontosUCService {
    ...
    public controle.ExtratoPontosUC getExtratoPontosUCPort() throws javax.xml.rpc.ServiceException {
    ...
    public controle.ExtratoPontosUC getExtratoPontosUCPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            controle.ExtratoPontosUCPortBindingStub _stub = new controle.ExtratoPontosUCPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (controle.ExtratoPontosUC.class.isAssignableFrom(serviceEndpointInterface)) {
                controle.ExtratoPontosUCPortBindingStub _stub = new controle.ExtratoPontosUCPortBindingStub(new java.net.URL(ExtratoPontosUCPort_address), this);
                _stub.setPortName(getExtratoPontosUCPortWSDDServiceName());
                return _stub;
            }
        }
