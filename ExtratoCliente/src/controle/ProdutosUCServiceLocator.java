...
public class ProdutosUCServiceLocator extends org.apache.axis.client.Service implements controle.ProdutosUCService {
    ...
    public controle.ProdutosUC getProdutosUCPort() throws javax.xml.rpc.ServiceException {
    ...
    public controle.ProdutosUC getProdutosUCPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            controle.ProdutosUCPortBindingStub _stub = new controle.ProdutosUCPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (controle.ProdutosUC.class.isAssignableFrom(serviceEndpointInterface)) {
                controle.ProdutosUCPortBindingStub _stub = new controle.ProdutosUCPortBindingStub(new java.net.URL(ProdutosUCPort_address), this);
                _stub.setPortName(getProdutosUCPortWSDDServiceName());
                return _stub;
            }
        }
