...
public class ProdutosUCProxy implements controle.ProdutosUC {
  private String _endpoint = null;
  private controle.ProdutosUC produtosUC = null;
  ...
  private void _initProdutosUCProxy() {
    try {
      produtosUC = (new controle.ProdutosUCServiceLocator()).getProdutosUCPort();
      if (produtosUC != null) {
        if (_endpoint != null)
  ...
  public controle.ProdutosUC getProdutosUC() {
    if (produtosUC == null)
      _initProdutosUCProxy();
    return produtosUC;
  }
